...
every-PR documentation + repo gate (v1.8):
...
- **Auto-invocations:** oc-stack-forge during oc-app-architect Phase 2; oc-ux-engineer during
  ...
  oc-docs-forge then oc-repo-ops from oc-git-ops before every PR.
...
- **PR documentation mesh (v1.8 "Documentation & repo hygiene"):** oc-docs-forge
  writes the PR body/comment documentation packet plus README/product docs, and
  oc-repo-ops verifies repo cleanliness and docs-packet presence before every PR.
  Gate order on every PR: oc-docs-forge → oc-repo-ops → oc-bug-check → oc-git-ops
  opens the PR. v1.8 takes the catalog to 29 skills.
